...
Low-level languages leave most of the processor details to the programmer. These programs can be more efficient, but harder to control. Examples include [[C|C/C++]].
## High-level
